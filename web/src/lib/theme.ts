...
const LIGHT: Scheme[] = [
  {
    ...
    vars: {
      ...
      '--color-priority': '#c2730a', '--color-purple': '#8b46c9', '--color-destructive': '#dc4338', '--color-text-dim': '#97a1b0',
      '--color-brand-foreground': '#ffffff',
    },
  },
  {
    ...
    vars: {
      ...
      '--color-priority': '#c2730a', '--color-purple': '#9456b0', '--color-destructive': '#cf4032', '--color-text-dim': '#a89f90',
      '--color-brand-foreground': '#ffffff',
    },
  },
  {
    ...
    vars: {
      ...
      '--color-priority': '#c2730a', '--color-purple': '#8b46c9', '--color-destructive': '#dc4338', '--color-text-dim': '#90a5a6',
      '--color-brand-foreground': '#ffffff',
    },
  },
]
